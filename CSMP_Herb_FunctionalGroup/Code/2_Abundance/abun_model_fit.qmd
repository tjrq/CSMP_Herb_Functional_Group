...
Analysis were conducted on total herbivore abundance and for each functional group independently. MCMC checks and model diagnostics were also conducted to see model fits.

Because Bayesian calculations take a while, all models were saved into the folder called "Model_Outputs". 
